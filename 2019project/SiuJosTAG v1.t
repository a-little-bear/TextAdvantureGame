...
%%%start
put "One year ago, a witch catch the princess to the witch's castle" ..
put ", and the witch said to the country " ..
put "'if you want to save the princess, you must kill me and my dragon.'" ..
put " But until now, no one can pass the thorns jungle, " ..
put " and you are trying to save the princess."

loop
    %play the game or not
    put ""
    put "Do you want to play the game?(Yes or No)"
    get sstart
    sstart := yesorno (sstart)

    if sstart = "yes" then
	put ""
	put "Let's start the game!"
...
procedure awesome
    cls
    Font.Draw ("thank you for giving me 'awesome'", 50, maxy div 30 * 20, font, blue)
    delay (3000)
    GUI.Refresh
end awesome
...
procedure good
    cls
    Font.Draw ("thank you for giving me 'good'", 50, maxy div 30 * 16, font, red)
    delay (3000)
    GUI.Refresh
end good
...
procedure fine
    cls
    Font.Draw ("thank you for giving me 'fine'", 50, maxy div 30 * 18, font, yellow)
    delay (3000)
    GUI.Refresh
end fine
...
procedure ok
    cls
    Font.Draw ("i will trying to be better", 50, maxy div 30 * 22, font, purple)
    delay (3000)
    GUI.Refresh
end ok
...
procedure nottoogood
    cls
    Font.Draw ("sorry about that, i will make better", 50, maxy div 30 * 24, font, brown)
    delay (3000)
    GUI.Refresh
end nottoogood
...
procedure bad
    cls
    Font.Draw ("that is fine, i will make more intersting, sorry", 50, maxy div 30 * 21, font, green)
    delay (3000)
    GUI.Refresh
end bad
...
cls
put "please give my game a score"

setscreen ("graphics:700,600")
var ibottum1 : int := GUI.CreateButtonFull (0, 0, 200, "awesome", awesome, 100, "^D", true)
var ibottum2 : int := GUI.CreateButtonFull (maxx div 3, 0, 200, "good", good, 100, "^D", true)
var ibottum3 : int := GUI.CreateButtonFull (maxx div 3 * 2, 0, 200, "fine", fine, 100, "^D", true)
var ibottum4 : int := GUI.CreateButtonFull (0, 125, 200, "ok", ok, 100, "^D", true)
...
var quit_ : int := GUI.CreateButtonFull (0, maxy - 100, 200, "quit", GUI.Quit, 100, "^D", true)
